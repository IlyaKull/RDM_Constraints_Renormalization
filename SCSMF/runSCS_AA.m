...
% each conjugate gradient iteration involves applying the affine
% constraints matrix A, its transposed A' or id + AA'. Those operations are
% implemented as function handles so that they can be fed into the matlab
% cg function
